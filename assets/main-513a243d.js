...
const vistaCervezas = {
  template: `
      <div class="mb-3">
        <div class="h3">${Cervezas[0].nombre}</div>
        <div>${Cervezas[0].descripcion}</div>
        <div>${Cervezas[0].imagen}</div>
        <div>${Cervezas[0].preu}</div>
      </div>
    `
};
const FormPedido = {
...
const Toolbar = {
  template: `
    <div class="ps-4">Ruben Henares Hidalgo</div>`
};
const TablaPedidos = {
  template: `
    <div class="col-6">
